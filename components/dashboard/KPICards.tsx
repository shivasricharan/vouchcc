...
const { stageCounts, pipelineValue, stuckCount, activeFunnelCount } = dzinehomeStats;
...
const kpis = [
  ...
  },
  {
    ...
    value: String(activeFunnelCount),
    sub: 'New → Negotiation',
    dot: 'bg-blue-500',
    text: 'text-blue-300',
  },
  ...
  {
    label: 'Site Visits',
    value: String(stageCounts['Site Visit']),
    sub: 'Scheduled / done',
    dot: 'bg-purple-400',
  ...
  },
  {
    ...
    value: String(stageCounts['Quotation Sent']),
  ...
  {
    label: 'Negotiations',
    value: String(stageCounts['Negotiation']),
    sub: 'In scope / price talk',
    dot: 'bg-orange-500',
    text: 'text-orange-300',
  },
  {
    label: 'Execution',
    value: String(stageCounts['Execution']),
    sub: 'Active projects',
    dot: 'bg-emerald-400',
  ...
  },
  {
    ...
    value: `₹${(pipelineValue / 100).toFixed(1)} Cr`,
