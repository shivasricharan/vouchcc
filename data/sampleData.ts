...
const generic: SampleTemplate = {
  ...
  description: 'B2B services company — consulting, technology, and support',
  icon: '🏢',
  leads: [
    lead('g01', 'Techstream Solutions',  'Website',    'Mumbai',    'Annual IT support contract',        'New Inquiry',   'Amit K.',    '2026-07-09', 1,  18, 20,  'Send service overview'),
    lead('g02', 'Kavya Builders',        'Referral',   'Pune',      'Process automation project',        'New Inquiry',   'Priya S.',   '2026-07-08', 2,  35, 15,  'Schedule discovery call'),
    lead('g03', 'Arvind Mehta',          'WhatsApp',   'Bangalore', 'Digital strategy consulting',       'New Inquiry',   'Unassigned', '2026-07-07', 3,  12, 10,  'Assign owner'),
    lead('g04', 'BlueLine Logistics',    'Google Ads', 'Chennai',   'ERP implementation — Phase 1',      'New Inquiry',   'Rahul M.',   '2026-07-09', 1,  45, 15,  'Send proposal template'),
    lead('g05', 'Ramesh & Associates',   'Email',      'Delhi',     'Quarterly compliance audit',        'New Inquiry',   'Amit K.',    '2026-07-05', 5,  8,  10,  'Call to qualify needs'),
    lead('g06', 'NovaChem Industries',   'Phone Call', 'Hyderabad', 'Safety training program',           'First Contact', 'Priya S.',   '2026-07-08', 2,  22, 25,  'Share past client results'),
    lead('g07', 'Seema Consulting',      'Website',    'Mumbai',    'Digital marketing retainer',        'First Contact', 'Rahul M.',   '2026-07-05', 5,  15, 20,  'Send case studies'),
    lead('g08', 'Orbit Manufacturing',   'Referral',   'Pune',      'Quality management consulting',     'First Contact', 'Amit K.',    '2026-07-01', 9,  28, 20,  'Follow up — went quiet'),
    lead('g09', 'Deepa Krishnamurthy',   'Instagram',  'Chennai',   'Brand identity package',            'First Contact', 'Unassigned', '2026-07-07', 3,  8,  15,  'Assign and call today'),
    lead('g10', 'Horizon Realty',        'Email',      'Bangalore', 'CRM setup & team training',         'Qualified',     'Priya S.',   '2026-07-08', 2,  55, 40,  'Prepare scoped proposal'),
    lead('g11', 'Kiran Vega Tech',       'WhatsApp',   'Hyderabad', 'Cloud migration consulting',        'Qualified',     'Rahul M.',   '2026-07-06', 4,  30, 35,  'Send cloud readiness report'),
    lead('g12', 'Precision Tools Ltd.',  'Referral',   'Delhi',     'ISO 9001 certification prep',       'Qualified',     'Amit K.',    '2026-07-04', 6,  42, 40,  'Arrange scoping workshop'),
    lead('g13', 'Sunlight Pharma',       'Website',    'Mumbai',    'ERP implementation — full cycle',   'Qualified',     'Priya S.',   '2026-06-29', 11, 80, 35,  'Revisit timeline and scope'),
    lead('g14', 'Priya Iyer Exports',    'Google Ads', 'Chennai',   'Export compliance consulting',      'Qualified',     'Unassigned', '2026-07-03', 7,  18, 30,  'Assign owner urgently'),
    lead('g15', 'AquaBuild Projects',    'Phone Call', 'Pune',      'Project management consulting',     'Proposal Sent', 'Rahul M.',   '2026-07-07', 3,  60, 55,  'Call to discuss proposal'),
    lead('g16', 'UrbanTech Solutions',   'Referral',   'Bangalore', 'Software license — 200 seats',      'Proposal Sent', 'Amit K.',    '2026-07-05', 5,  48, 50,  'Address pricing questions'),
    lead('g17', 'Manoj Thakur & Co.',    'Email',      'Hyderabad', 'Financial controls audit',          'Proposal Sent', 'Priya S.',   '2026-06-30', 10, 70, 50,  'Revise scope per feedback'),
    lead('g18', 'Coastal Exporters',     'WhatsApp',   'Mumbai',    'Logistics optimisation study',      'Proposal Sent', 'Rahul M.',   '2026-07-08', 2,  35, 55,  'Send updated cost breakdown'),
    lead('g19', 'DynaCorp Pvt. Ltd.',    'Referral',   'Delhi',     'Six Sigma implementation',          'Negotiation',   'Amit K.',    '2026-07-07', 3,  90, 65,  'Finalise discount structure'),
    lead('g20', 'TrustBridge Finance',   'Google Ads', 'Pune',      'Risk management framework',         'Negotiation',   'Priya S.',   '2026-07-06', 4,  55, 60,  'Send final contract draft'),
    lead('g21', 'Reliance Merchant',     'Phone Call', 'Bangalore', 'Supply chain audit — 3 plants',     'Negotiation',   'Rahul M.',   '2026-07-02', 8,  42, 70,  'Close this week — board deadline'),
    lead('g22', 'Kavitha Exports',       'Website',    'Chennai',   'Trade compliance training',         'Negotiation',   'Unassigned', '2026-07-04', 6,  25, 60,  'Assign closer immediately'),
    lead('g23', 'Prism Analytics',       'Referral',   'Hyderabad', 'Data analytics consulting',         'Completed',     'Amit K.',    '2026-05-20', 2,  65, 100, 'Request case study'),
    lead('g24', 'Sanjay Nair Builders',  'Email',      'Mumbai',    'Project management consulting',     'Completed',     'Priya S.',   '2026-05-15', 1,  40, 100, 'Send thank-you note'),
    lead('g25', 'Metro Infra Group',     'Website',    'Pune',      'ERP implementation — Phase 2',      'Completed',     'Rahul M.',   '2026-05-25', 3,  95, 100, 'Upsell Phase 3'),
    lead('g26', 'BrightPath Edu',        'Referral',   'Bangalore', 'Digital strategy consulting',       'Lost',          'Amit K.',    '2026-06-01', 5,  30, 0,   'Archive — went with competitor'),
    lead('g27', 'Global Freight Co.',    'Google Ads', 'Delhi',     'Logistics ERP license',             'Lost',          'Priya S.',   '2026-05-28', 3,  20, 0,   'Archive — budget freeze'),
    lead('g28', 'Ravi Kumar & Sons',     'Phone Call', 'Chennai',   'Quality audit — manufacturing',     'Lost',          'Rahul M.',   '2026-06-05', 4,  48, 0,   'Re-engage next quarter'),
    lead('g29', 'Sapphire Interiors',    'Instagram',  'Hyderabad', 'Brand identity + website',          'New Inquiry',   'Priya S.',   '2026-07-09', 1,  10, 10,  'Send portfolio'),
    lead('g30', 'Delta Force Security',  'WhatsApp',   'Mumbai',    'Compliance audit — ISO 27001',      'First Contact', 'Amit K.',    '2026-07-07', 3,  65, 25,  'Send capability document'),
    lead('g31', 'Preethi Associates',    'Referral',   'Pune',      'Tax planning & advisory',           'Qualified',     'Rahul M.',   '2026-07-02', 8,  20, 35,  'Revisit scope'),
    lead('g32', 'InnoVision Systems',    'Email',      'Bangalore', 'ERP consulting — 500 user rollout', 'Proposal Sent', 'Unassigned', '2026-06-28', 12, 75, 45,  'Assign and follow up today'),
  ],
};
