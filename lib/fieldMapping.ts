...
export const FIELD_DEFS: { key: keyof ColumnMap; label: string; required?: boolean; candidates: string[] }[] = [
  { key: 'client', label: 'Client Name', required: true, candidates: ['client', 'name', 'full name', 'customer', 'customer name', 'client name', 'lead name', 'contact name', 'prospect', 'company', 'business name', 'student name', 'patient name', 'buyer'] },
  { key: 'stage', label: 'Stage / Status', required: true, candidates: ['stage', 'status', 'pipeline stage', 'current stage', 'funnel stage', 'sales stage', 'lead status', 'current status', 'phase', 'step'] },
  { key: 'source', label: 'Lead Source', candidates: ['source', 'lead source', 'channel', 'campaign', 'ad source', 'origin', 'how did you hear', 'medium', 'utm source', 'marketing channel', 'referral source'] },
  ...
  { key: 'value', label: 'Deal Value', candidates: ['value', 'deal value', 'budget', 'amount', 'project value', 'revenue', 'deal size', 'expected value', 'total value', 'contract value', 'fee', 'price', 'cost', 'quote amount'] },
  { key: 'phone', label: 'Phone', candidates: ['phone', 'mobile', 'whatsapp', 'whatsapp number', 'contact number', 'phone number', 'cell', 'telephone', 'mobile number', 'contact'] },
  ...
  { key: 'requirement', label: 'Inquiry Type', candidates: ['requirement', 'requirements', 'inquiry type', 'inquiry_type', 'business type', 'business_type', 'project', 'scope', 'work', 'description', 'details', 'service', 'product', 'need', 'interest', 'course', 'property type'] },
  { key: 'createdAt', label: 'Created Date', candidates: ['created', 'created at', 'created date', 'lead date', 'enquiry date', 'inquiry date', 'date', 'registration date', 'signup date', 'entry date', 'date added', 'date created'] },
  { key: 'lastContacted', label: 'Last Updated', candidates: ['last contacted', 'last contact', 'last updated', 'last follow up', 'last follow-up', 'last followup', 'follow up date', 'follow-up date', 'contact date', 'last activity', 'updated', 'updated at', 'last modified', 'last touch'] },
  { key: 'daysInStage', label: 'Days in Stage', candidates: ['days in stage', 'days', 'age', 'days stuck', 'stage days', 'days old', 'lead age', 'response time', 'response_time_hours', 'response_time'] },
  { key: 'daysSinceUpdate', label: 'Days Since Update', candidates: ['days since update', 'days inactive', 'inactivity', 'days since contact'] },
  { key: 'probability', label: 'Intent Level', candidates: ['intent', 'intent level', 'intent_level', 'priority', 'lead score', 'score', 'probability', 'likelihood', 'confidence', 'win probability', 'close probability', 'chance', 'rating', 'lead rating'] },
  { key: 'nextAction', label: 'Next Action', candidates: ['next action', 'action', 'next step', 'follow up', 'next follow-up', 'next followup', 'next_followup_date', 'next followup date', 'next follow-up date', 'follow-up date', 'remarks', 'comments', 'conversation', 'notes', 'comment', 'todo', 'task'] },
  { key: 'ownerTeam', label: 'Team', candidates: ['team', 'department', 'group', 'division', 'owner team'] },
  { key: 'status', label: 'Status', candidates: ['status', 'lead status', 'deal status', 'current status', 'active', 'state'] },
